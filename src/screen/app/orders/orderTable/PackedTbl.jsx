...
const PackedTbl = () => {
    ...
    const [validationErrors, setValidationErrors] = useState({
        ...
        transportMobile: '',
        driverMobile: '',
        transportCharges: '' // Add this field
    });
    ...
    const handleDetailsClick = (orderId, buyerName, shippingAddress) => {
        ...
        setTransportDetails({
            transportName: '',
            transportMobile: '',
            transportCharges: '', // Add this line
            vehicleNo: '',
            driverMobile: '',
            transportEmail: '',
            challanImageUrl: ''
    ...
    const handleSubmitTransportDetails = async () => {
        ...
        if (!transportDetails.transportCharges) {  // Add validation for transport charges
            errors.transportCharges = 'Transport Charges are required';
        } else if (isNaN(transportDetails.transportCharges) || transportDetails.transportCharges < 0) {
            errors.transportCharges = 'Please enter a valid positive number';
        }
        ...
        try {
            const payload = {
                ...
                transportCharges: transportDetails.transportCharges, // Add this field
    ...
    const isSubmitDisabled = !transportDetails.transportName ||
        ...
        !transportDetails.transportCharges || // Add this condition
        submitLoading ||
                                    ...
                                    <div className="row mb-2">
                                        <div className="col-md-6">
                                            ...
                                            <input
                                                ...
                                                value={transportDetails.transportCharges}
                                                onChange={handleTransportChange}
                                                disabled={uploading}
                                                required
                                            />
                                            {validationErrors.transportCharges && (
                                                <small className="text-danger">{validationErrors.transportCharges}</small>
                                            )}
                                        </div>
                                        <div className="col-md-6">
