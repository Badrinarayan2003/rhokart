...
//     const addressDetails = useSelector((state) => state.registration?.addressDetails);
//     console.log(addressDetails, "address details in address from store");
...
//     useEffect(() => {
//         if (addressDetails) {
//             // Update billing address fields if data exists
...
//             // Update pickup address fields if data exists
//             if (addressDetails?.pickupAddress) {
//                 setPickupAddress({
//                     addressLine1: addressDetails.pickupAddress.addressLine1 || "",
//                     addressLine2: addressDetails.pickupAddress.addressLine2 || "",
//                     pincode: addressDetails.pickupAddress.pincode || "",
...
//             // Mark as saved since we have existing data
//             setIsSaved(true);
//         }
//     }, [addressDetails]); // This effect runs when addressDetails changes
...
//     // Validate form fields
//     const validateFields = () => {
//         // Required fields for both addresses
